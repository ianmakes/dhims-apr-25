  ...
  return (
    <div className="space-y-3">
      {recentSponsorships.map((student) => (
        <div key={student.id} className="flex items-center space-x-3 p-2 rounded hover:bg-wp-gray-50 transition-colors">
          <div className="h-10 w-10 bg-wp-primary/10 rounded-full flex items-center justify-center">
