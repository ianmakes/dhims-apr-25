...
interface SponsorTimelineTabProps {
  ...
  onUpdateTimelineEvent: (data: Partial<SponsorTimelineEvent> & {
    id: string;
  }) => void;
  ...
  return <div>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-left">Sponsor Timeline</CardTitle>
                  ...
                  <div>
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex space-x-2">
                        <Button variant="ghost" size="icon" onClick={() => handleEditDialogOpen(event)} className="h-8 w-8">
                          <Pencil className="h-4 w-4" />
                          <span className="sr-only">Edit event</span>
                        </Button>
                        <Button variant="ghost" size="icon" onClick={() => handleDeleteDialogOpen(event)} className="h-8 w-8 text-destructive hover:text-destructive hover:bg-destructive/10">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleAddSubmit)} className="space-y-4">
              ...
              field
                    ...
                    <FormControl>
                      <Textarea placeholder="Event details (optional)" {...field} value={field.value || ""} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
      ...
      {selectedEvent && <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
          <DialogContent>
            <DialogHeader>
            ...
            <Form {...editForm}>
              ...
              field
                ...
                <FormField control={editForm.control} name="description" render={({
              field
            }) => <FormItem>
                      <FormLabel>Description</FormLabel>
                      <FormControl>
                ...
                <FormField control={editForm.control} name="type" render={({
              field
            }) => <FormItem>
                      <FormLabel>Event Type</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
